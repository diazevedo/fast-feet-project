...
<h2 align="center">
  <img alt="Web login page" src=".github/laptop-login.png" width="40%" />
  <img alt="Mobile login page" src=".github/mobile-login.png" width="15%" />
</h2>
...
- [Backend](https://github.com/diazevedo/fast-feet)
- [Frontend](https://github.com/diazevedo/fast-feet-web)
- [Mobile](https://github.com/diazevedo/fast-feet-mobile)
